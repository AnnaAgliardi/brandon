...
import { ArrowLeft, Loader2, Trash2, Edit, Image as ImageIcon } from 'lucide-react'
    ...
    {/* Assets Table */ }
{
    ...
    className =\"w-16 h-16 object-cover rounded\"
        ...
        <td className=\"px-4 py-3 max-w-xs\">
            < p className =\"text-sm truncate\">{asset.llm_description}</p>
                        </td >
        <td className=\"px-4 py-3 text-sm\">{asset.brand || '-'}</td>
            < td className =\"px-4 py-3 text-sm\">{asset.region_representation || '-'}</td>
                < td className =\"px-4 py-3\">
                    < span className = {`px-2 py-1 rounded text-xs ${asset.status === 'approved' ? 'bg-green-100 text-green-800' :
    ...
    <td className=\"px-4 py-3 text-sm\">{asset.license_type_usage}</td>
        < td className =\"px-4 py-3\">
    ...
    <div className=\"space-y-2\">
        < Label > License Type(Usage)</Label >
                  <Select
                    ...
                    onValueChange={(value) =>
                      setEditMetadata({ ...editMetadata, license_type_usage: value })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
    ...
    <div className=\"space-y-2\">
        < Label > License Type(Subscription)</Label >
            <Select
                ...
                onValueChange={(value) =>
                    setEditMetadata({ ...editMetadata, license_type_subscription: value })
                }
            >
                <SelectTrigger>
                    <SelectValue />
    ...
    <div className=\"space-y-2\">
        < Label > Region</Label >
                  <Select
                    ...
                    onValueChange={(value) =>
                      setEditMetadata({ ...editMetadata, region_representation: value })
                    }
                  >
                    <SelectTrigger>
    ...
    <div className=\"space-y-2\">
        < Label > Campaign</Label >
            <Input
                ...
                onChange={(e) =>
                    setEditMetadata({ ...editMetadata, campaign: e.target.value })
                }
            />
                </div >
    ...
    <div className=\"space-y-2\">
        < Label > Location</Label >
            <Input
                ...
                onChange={(e) =>
                    setEditMetadata({ ...editMetadata, location: e.target.value })
                }
            />
                </div >
              </div >
